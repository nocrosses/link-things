 ...
 *  Notify Me With Hue
 *
 *  Author: Nocrosses mofification of Smartthings
 *  Date: 2014-01-20
 */
definition(
    name: "Test - Notify me with Hue",
    namespace: "nocrosses",
    author: "nocrosses",
...
def resetHue()
{
//Hacking together default White color for now.
	def newValue = [hue: 0, saturation: 0, level: 75]   
    hues*.setColor(newValue)
   	runIn(1, "gah", [overwrite:false]);
...
def gah()
{
	hues*.setColor(hue: 50, saturation: 0, level: 75);
}